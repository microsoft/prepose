; brush-kneeXbrush-knee-manual-interpolation-8
...
(let ((?x3585 (* (/ 7.0 80.0) ?x391)))
(let ((?x10423 (* (/ 249.0 250.0) ?x395)))
(let (($x11379 (>= ?x395 0.0)))
(let ((?x1189 (- 0.0 ?x395)))
(let ((?x7762 (ite $x11379 ?x395 ?x1189)))
(let ((?x5213 (+ ?x169 ?x176)))
(let ((?x4162 (+ ?x169 ?x179)))
...
(let ((?x237 (- 0.0 ?x346)))
(let (($x9298 (>= ?x346 0.0)))
(let ((?x2320 (ite $x9298 ?x346 ?x237)))
(let (($x7093 (>= ?x2320 ?x7762)))
(let ((?x11068 (ite $x7093 ?x395 (ite $x11379 (+ ?x10423 (* (~ (/ 7.0 80.0)) ?x391)) (+ ?x10423 ?x3585)))))
(let ((?x6757 (+ (+ (+ ?x4357 (* ?x11068 |WristLeft Norm|)) (* ?x395 |ElbowLeft Norm|)) ?x420)))
(let ((?x4175 (- ?x6544 (+ (+ (+ ?x6757 ?x435) ?x159) ?x5357))))
(let ((?x2509 (ite (>= ?x4175 0.0) ?x4175 (- 0.0 ?x4175))))
(let ((?x140 (ite $x11379 (+ (* (/ 7.0 80.0) ?x395) (* (/ 249.0 250.0) ?x391)) (+ (* (~ (/ 7.0 80.0)) ?x395) (* (/ 249.0 250.0) ?x391)))))
(let ((?x7640 (ite $x9298 (+ (* (/ 7.0 80.0) ?x346) (* (/ 249.0 250.0) ?x391)) (+ (* (~ (/ 7.0 80.0)) ?x346) (* (/ 249.0 250.0) ?x391)))))
(let ((?x7248 (ite $x7093 ?x7640 ?x140)))
(let ((?x3833 (+ (+ (+ ?x3426 (* ?x7248 |WristLeft Norm|)) (* ?x391 |ElbowLeft Norm|)) ?x417)))
(let ((?x10970 (- ?x6588 (+ (+ (+ ?x3833 ?x427) ?x443) ?x5556))))
(let ((?x7060 (ite (>= ?x10970 0.0) ?x10970 (- 0.0 ?x10970))))
(let ((?x1129 (ite $x9298 (+ (* (/ 249.0 250.0) ?x346) (* (~ (/ 7.0 80.0)) ?x391)) (+ (* (/ 249.0 250.0) ?x346) ?x3585))))
(let ((?x2508 (ite $x7093 ?x1129 ?x346)))
(let ((?x9509 (+ (+ (+ ?x4526 (* ?x2508 |WristLeft Norm|)) (* ?x346 |ElbowLeft Norm|)) ?x416)))
(let ((?x8916 (- ?x6584 (+ (+ (+ ?x9509 ?x426) ?x441) ?x5403))))
(let ((?x6097 (ite (>= ?x8916 0.0) ?x8916 (- 0.0 ?x8916))))
(let ((?x10956 (ite (>= ?x6097 ?x7060) ?x6097 ?x7060)))
...
(let ((?x357 (+ ?x356 ?x116)))
(let ((?x2931 (ite $x5024 1.0 (ite $x350 (+ ?x356 (* (~ (/ 193.0 200.0)) 0.0)) ?x357))))
(let ((?x10562 (+ (+ (+ ?x4357 (* ?x2931 |WristLeft Norm|)) (* ?x4943 |ElbowLeft Norm|)) ?x420)))
(let ((?x11638 (- ?x7779 (+ (+ (+ ?x10562 ?x435) ?x159) ?x5357))))
(let ((?x10993 (ite (>= ?x11638 0.0) ?x11638 (- 0.0 ?x11638))))
...
(let ((?x364 (+ ?x363 ?x123)))
(let ((?x6485 (ite $x5024 (ite $x112 (+ ?x116 ?x123) (+ (* (~ (/ 193.0 200.0)) 0.0) ?x123)) (ite $x350 ?x364 (+ (* (~ (/ 193.0 200.0)) 1.0) ?x123)))))
(let ((?x7491 (+ (+ (+ ?x3426 (* ?x6485 |WristLeft Norm|)) (* ?x4937 |ElbowLeft Norm|)) ?x417)))
(let ((?x7448 (- ?x7959 (+ (+ (+ ?x7491 ?x427) ?x443) ?x5556))))
(let ((?x3256 (ite (>= ?x7448 0.0) ?x7448 (- 0.0 ?x7448))))
(let ((?x11132 (ite $x5024 (ite $x112 (+ ?x123 (* (~ (/ 193.0 200.0)) 0.0)) (+ ?x123 ?x116)) 0.0)))
(let ((?x7722 (+ (+ ?x4526 (* ?x11132 |WristLeft Norm|)) (* (ite $x5024 (ite $x112 ?x5213 ?x4162) 0.0) |ElbowLeft Norm|))))
(let ((?x8969 (- ?x7955 (+ (+ (+ (+ ?x7722 ?x416) ?x426) ?x441) ?x5403))))
(let ((?x10261 (ite (>= ?x8969 0.0) ?x8969 (- 0.0 ?x8969))))
(let ((?x9188 (ite (>= ?x10261 ?x3256) ?x10261 ?x3256)))
(let (($x8079 (and $x10995 true)))
(let (($x8951 (and (and $x8079 (and true (< (ite (>= ?x9188 ?x10993) ?x9188 ?x10993) (/ 1.0 5.0)))) true)))
(let (($x6118 (and $x8951 (and true (< (ite (>= ?x10956 ?x2509) ?x10956 ?x2509) (/ 1.0 5.0))))))
