; brush-kneeXbrush-knee-manual-interpolation-10
...
(let ((?x9936 (+ ?x10423 ?x3585)))
(let ((?x9637 (* (~ (/ 7.0 80.0)) ?x391)))
(let ((?x9481 (+ ?x10423 ?x9637)))
(let (($x11379 (>= ?x395 0.0)))
(let ((?x6758 (ite $x11379 ?x9481 ?x9936)))
(let ((?x1189 (- 0.0 ?x395)))
...
(let ((?x11068 (ite $x7093 ?x395 ?x6758)))
(let ((?x11370 (* ?x11068 |WristLeft Norm|)))
(let ((?x11208 (+ ?x4357 ?x11370)))
(let ((?x4726 (+ ?x11208 ?x3217)))
(let ((?x6757 (+ ?x4726 ?x420)))
(let ((?x7292 (+ ?x6757 ?x435)))
(let ((?x4374 (+ ?x7292 ?x159)))
(let ((?x10162 (+ ?x4374 ?x5357)))
(let ((?x4175 (- ?x6544 ?x10162)))
(let ((?x8019 (- 0.0 ?x4175)))
(let (($x7976 (>= ?x4175 0.0)))
(let ((?x2509 (ite $x7976 ?x4175 ?x8019)))
(let ((?x11264 (* ?x391 |ElbowLeft Norm|)))
(let ((?x8186 (* (/ 249.0 250.0) ?x391)))
(let ((?x8133 (* (~ (/ 7.0 80.0)) ?x395)))
(let ((?x10841 (+ ?x8133 ?x8186)))
(let ((?x9894 (* (/ 7.0 80.0) ?x395)))
(let ((?x11206 (+ ?x9894 ?x8186)))
(let ((?x140 (ite $x11379 ?x11206 ?x10841)))
(let ((?x8146 (* (~ (/ 7.0 80.0)) ?x346)))
(let ((?x8164 (+ ?x8146 ?x8186)))
(let ((?x5479 (* (/ 7.0 80.0) ?x346)))
(let ((?x9208 (+ ?x5479 ?x8186)))
(let ((?x7640 (ite $x9298 ?x9208 ?x8164)))
(let ((?x7248 (ite $x7093 ?x7640 ?x140)))
(let ((?x3220 (* ?x7248 |WristLeft Norm|)))
(let ((?x11615 (+ ?x3426 ?x3220)))
(let ((?x3302 (+ ?x11615 ?x11264)))
(let ((?x3833 (+ ?x3302 ?x417)))
(let ((?x11385 (+ ?x3833 ?x427)))
(let ((?x8266 (+ ?x11385 ?x443)))
(let ((?x5040 (+ ?x8266 ?x5556)))
(let ((?x10970 (- ?x6588 ?x5040)))
(let ((?x881 (- 0.0 ?x10970)))
(let (($x4302 (>= ?x10970 0.0)))
(let ((?x7060 (ite $x4302 ?x10970 ?x881)))
(let ((?x5177 (* ?x346 |ElbowLeft Norm|)))
(let ((?x10076 (* (/ 249.0 250.0) ?x346)))
(let ((?x139 (+ ?x10076 ?x3585)))
(let ((?x7240 (+ ?x10076 ?x9637)))
(let ((?x1129 (ite $x9298 ?x7240 ?x139)))
(let ((?x2508 (ite $x7093 ?x1129 ?x346)))
(let ((?x9386 (* ?x2508 |WristLeft Norm|)))
(let ((?x7433 (+ ?x4526 ?x9386)))
(let ((?x4830 (+ ?x7433 ?x5177)))
(let ((?x9509 (+ ?x4830 ?x416)))
(let ((?x6947 (+ ?x9509 ?x426)))
(let ((?x3885 (+ ?x6947 ?x441)))
(let ((?x3306 (+ ?x3885 ?x5403)))
(let ((?x8916 (- ?x6584 ?x3306)))
(let ((?x7751 (- 0.0 ?x8916)))
(let (($x10891 (>= ?x8916 0.0)))
(let ((?x6097 (ite $x10891 ?x8916 ?x7751)))
(let (($x990 (>= ?x6097 ?x7060)))
(let ((?x10956 (ite $x990 ?x6097 ?x7060)))
(let (($x6907 (>= ?x10956 ?x2509)))
(let ((?x8305 (ite $x6907 ?x10956 ?x2509)))
(let (($x10919 (< ?x8305 (/ 1.0 5.0))))
(let (($x7846 (and true $x10919)))
(let (($x8951 (and $x2877 true)))
(let (($x6118 (and $x8951 $x7846)))
