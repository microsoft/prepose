; fifth-position-en-avantXa-la-quatrieme-derriere
...
(let ((?x415 (+ ?x412 ?x279)))
(let ((?x418 (+ ?x415 ?x273)))
(let (($x691 (and true (< ?x418 ?x711))))
(let (($x681 (and $x691 (< ?x285 ?x711))))
(let (($x682 (and $x681 (< ?x418 ?x697))))
(let (($x670 (and $x682 (< ?x285 ?x697))))
(let (($x1877 (and true true)))
(let (($x4687 (and $x1877 true)))
(let (($x5493 (and (and $x4687 $x670) true)))
