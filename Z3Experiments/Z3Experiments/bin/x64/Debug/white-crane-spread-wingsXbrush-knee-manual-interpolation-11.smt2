; white-crane-spread-wingsXbrush-knee-manual-interpolation-11
...
(let ((?x3508 (* ?x4943 |ElbowLeft Norm|)))
(let ((?x116 (* (/ 193.0 200.0) 0.0)))
(let ((?x356 (* (/ 129.0 500.0) 1.0)))
(let ((?x357 (+ ?x356 ?x116)))
(let ((?x6358 (* (~ (/ 193.0 200.0)) 0.0)))
(let ((?x6164 (+ ?x356 ?x6358)))
(let ((?x3039 (ite $x350 ?x6164 ?x357)))
(let ((?x10066 (ite $x5024 1.0 ?x3039)))
(let ((?x1205 (* ?x10066 |WristLeft Norm|)))
(let ((?x4357 (+ 0.0 ?x5357)))
(let ((?x6324 (+ ?x4357 ?x1205)))
(let ((?x1322 (+ ?x6324 ?x3508)))
(let ((?x1165 (+ ?x1322 ?x420)))
(let ((?x7326 (+ ?x1165 ?x435)))
(let ((?x7738 (+ ?x7326 ?x159)))
(let ((?x7701 (+ ?x7738 ?x5357)))
...
(let ((?x6397 (- ?x7779 ?x7701)))
(let ((?x10626 (- 0.0 ?x6397)))
(let (($x7805 (>= ?x6397 0.0)))
(let ((?x8773 (ite $x7805 ?x6397 ?x10626)))
...
(let ((?x1691 (* ?x4937 |ElbowLeft Norm|)))
(let ((?x123 (* (/ 129.0 500.0) 0.0)))
(let ((?x9296 (* (~ (/ 193.0 200.0)) 1.0)))
(let ((?x6462 (+ ?x9296 ?x123)))
(let ((?x363 (* (/ 193.0 200.0) 1.0)))
(let ((?x364 (+ ?x363 ?x123)))
(let ((?x7771 (ite $x350 ?x364 ?x6462)))
(let ((?x7473 (+ ?x6358 ?x123)))
(let ((?x368 (+ ?x116 ?x123)))
(let ((?x2666 (ite $x112 ?x368 ?x7473)))
(let ((?x1937 (ite $x5024 ?x2666 ?x7771)))
(let ((?x8874 (* ?x1937 |WristLeft Norm|)))
(let ((?x3426 (+ 0.0 ?x5556)))
(let ((?x10503 (+ ?x3426 ?x8874)))
(let ((?x7697 (+ ?x10503 ?x1691)))
(let ((?x11279 (+ ?x7697 ?x417)))
(let ((?x8046 (+ ?x11279 ?x427)))
(let ((?x8385 (+ ?x8046 ?x443)))
(let ((?x6497 (+ ?x8385 ?x5556)))
...
(let ((?x10959 (- ?x7959 ?x6497)))
(let ((?x3590 (- 0.0 ?x10959)))
(let (($x10535 (>= ?x10959 0.0)))
(let ((?x11509 (ite $x10535 ?x10959 ?x3590)))
...
(let ((?x10947 (* ?x4935 |ElbowLeft Norm|)))
(let ((?x360 (+ ?x123 ?x116)))
(let ((?x9994 (+ ?x123 ?x6358)))
(let ((?x2494 (ite $x112 ?x9994 ?x360)))
(let ((?x6964 (ite $x5024 ?x2494 0.0)))
(let ((?x8098 (* ?x6964 |WristLeft Norm|)))
(let ((?x4526 (+ 0.0 ?x5403)))
(let ((?x7232 (+ ?x4526 ?x8098)))
(let ((?x8072 (+ ?x7232 ?x10947)))
(let ((?x9472 (+ ?x8072 ?x416)))
(let ((?x7824 (+ ?x9472 ?x426)))
(let ((?x7443 (+ ?x7824 ?x441)))
(let ((?x6492 (+ ?x7443 ?x5403)))
...
(let ((?x7360 (- ?x7955 ?x6492)))
(let ((?x8165 (- 0.0 ?x7360)))
(let (($x11002 (>= ?x7360 0.0)))
(let ((?x10955 (ite $x11002 ?x7360 ?x8165)))
(let (($x9614 (>= ?x10955 ?x11509)))
(let ((?x6886 (ite $x9614 ?x10955 ?x11509)))
(let (($x3338 (>= ?x6886 ?x8773)))
(let ((?x8828 (ite $x3338 ?x6886 ?x8773)))
(let (($x9123 (< ?x8828 (/ 1.0 5.0))))
(let (($x7689 (and true $x9123)))
...
(let (($x8856 (and $x8079 $x7689)))
(let (($x8223 (and $x8856 true)))
