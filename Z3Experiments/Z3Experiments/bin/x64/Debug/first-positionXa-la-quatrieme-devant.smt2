; first-positionXa-la-quatrieme-devant
...
(let ((?x415 (+ ?x412 ?x279)))
(let ((?x418 (+ ?x415 ?x273)))
(let (($x431 (and true (> ?x418 ?x429))))
(let (($x433 (and $x431 (> ?x285 ?x429))))
(let (($x448 (and $x433 (> ?x418 ?x446))))
(let (($x450 (and $x448 (> ?x285 ?x446))))
...
(let (($x1404 (and $x5034)))
(and $x1404 $x4998 (and (and $x4687 $x450) true)))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
