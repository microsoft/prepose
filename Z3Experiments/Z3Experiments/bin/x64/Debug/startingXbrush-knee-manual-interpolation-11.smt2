; startingXbrush-knee-manual-interpolation-11
...
(let ((?x10975 (* ?x4943 |ElbowLeft Norm|)))
(let ((?x116 (* (/ 193.0 200.0) 0.0)))
(let ((?x356 (* (/ 129.0 500.0) 1.0)))
(let ((?x357 (+ ?x356 ?x116)))
(let ((?x2575 (* (~ (/ 193.0 200.0)) 0.0)))
(let ((?x11451 (+ ?x356 ?x2575)))
(let ((?x6166 (ite $x350 ?x11451 ?x357)))
(let ((?x7656 (ite $x5024 1.0 ?x6166)))
(let ((?x10825 (* ?x7656 |WristLeft Norm|)))
(let ((?x4357 (+ 0.0 ?x5357)))
(let ((?x10949 (+ ?x4357 ?x10825)))
(let ((?x10584 (+ ?x10949 ?x10975)))
(let ((?x241 (+ ?x10584 ?x420)))
(let ((?x6196 (+ ?x241 ?x435)))
(let ((?x11379 (+ ?x6196 ?x159)))
(let ((?x11318 (+ ?x11379 ?x5357)))
...
(let ((?x10967 (- ?x7779 ?x11318)))
(let ((?x8115 (- 0.0 ?x10967)))
(let (($x7303 (>= ?x10967 0.0)))
(let ((?x7035 (ite $x7303 ?x10967 ?x8115)))
...
(let ((?x10810 (* ?x4937 |ElbowLeft Norm|)))
(let ((?x123 (* (/ 129.0 500.0) 0.0)))
(let ((?x1211 (* (~ (/ 193.0 200.0)) 1.0)))
(let ((?x1017 (+ ?x1211 ?x123)))
(let ((?x363 (* (/ 193.0 200.0) 1.0)))
(let ((?x364 (+ ?x363 ?x123)))
(let ((?x9146 (ite $x350 ?x364 ?x1017)))
(let ((?x1200 (+ ?x2575 ?x123)))
(let ((?x368 (+ ?x116 ?x123)))
(let ((?x11196 (ite $x112 ?x368 ?x1200)))
(let ((?x2291 (ite $x5024 ?x11196 ?x9146)))
(let ((?x7020 (* ?x2291 |WristLeft Norm|)))
(let ((?x3426 (+ 0.0 ?x5556)))
(let ((?x10829 (+ ?x3426 ?x7020)))
(let ((?x7055 (+ ?x10829 ?x10810)))
(let ((?x11058 (+ ?x7055 ?x417)))
(let ((?x11777 (+ ?x11058 ?x427)))
(let ((?x10502 (+ ?x11777 ?x443)))
(let ((?x11578 (+ ?x10502 ?x5556)))
...
(let ((?x6870 (- ?x7959 ?x11578)))
(let ((?x9481 (- 0.0 ?x6870)))
(let (($x1310 (>= ?x6870 0.0)))
(let ((?x3976 (ite $x1310 ?x6870 ?x9481)))
...
(let ((?x7250 (* ?x4935 |ElbowLeft Norm|)))
(let ((?x360 (+ ?x123 ?x116)))
(let ((?x3032 (+ ?x123 ?x2575)))
(let ((?x2653 (ite $x112 ?x3032 ?x360)))
(let ((?x1937 (ite $x5024 ?x2653 0.0)))
(let ((?x3514 (* ?x1937 |WristLeft Norm|)))
(let ((?x4526 (+ 0.0 ?x5403)))
(let ((?x7007 (+ ?x4526 ?x3514)))
(let ((?x10526 (+ ?x7007 ?x7250)))
(let ((?x10874 (+ ?x10526 ?x416)))
(let ((?x3076 (+ ?x10874 ?x426)))
(let ((?x11003 (+ ?x3076 ?x441)))
(let ((?x10936 (+ ?x11003 ?x5403)))
...
(let ((?x2227 (- ?x7955 ?x10936)))
(let ((?x11301 (- 0.0 ?x2227)))
(let (($x3227 (>= ?x2227 0.0)))
(let ((?x10594 (ite $x3227 ?x2227 ?x11301)))
(let (($x6624 (>= ?x10594 ?x3976)))
(let ((?x1596 (ite $x6624 ?x10594 ?x3976)))
(let (($x5011 (>= ?x1596 ?x7035)))
(let ((?x6388 (ite $x5011 ?x1596 ?x7035)))
(let (($x10003 (< ?x6388 (/ 1.0 5.0))))
(let (($x1287 (and true $x10003)))
...
(let (($x3491 (< ?x6109 ?x5646)))
(let (($x3481 (and true $x3491)))
(let ((?x8168 (+ ?x6109 (/ 1.0 10.0))))
(let (($x8784 (> ?x7283 ?x8168)))
(let (($x8318 (and true $x8784)))
...
(let (($x8789 (and $x10212 $x8318)))
(let (($x3220 (and $x8789 $x3481)))
(let (($x3513 (and $x3220 true)))
(let (($x10774 (and $x3513 $x1287)))
(let (($x2571 (and $x10774 true)))
