; crossover-left-arm-stretchXhead-rolls
...
(assert
(let (($x9593 (and (and (and (and true true) true) true) true)))
(let (($x10868 (and (and (and (and (and (and $x9593 true) true) true) true) true) true)))
...
(and $x9765 $x8791 (and (and $x10868 true) true)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
