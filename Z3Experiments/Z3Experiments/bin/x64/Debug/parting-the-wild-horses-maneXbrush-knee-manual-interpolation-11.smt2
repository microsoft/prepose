; parting-the-wild-horses-maneXbrush-knee-manual-interpolation-11
...
(let ((?x4546 (* ?x4943 |ElbowLeft Norm|)))
(let ((?x116 (* (/ 193.0 200.0) 0.0)))
(let ((?x356 (* (/ 129.0 500.0) 1.0)))
(let ((?x357 (+ ?x356 ?x116)))
(let ((?x10579 (* (~ (/ 193.0 200.0)) 0.0)))
(let ((?x7247 (+ ?x356 ?x10579)))
(let ((?x7837 (ite $x350 ?x7247 ?x357)))
(let ((?x6816 (ite $x5024 1.0 ?x7837)))
(let ((?x7389 (* ?x6816 |WristLeft Norm|)))
(let ((?x4357 (+ 0.0 ?x5357)))
(let ((?x6164 (+ ?x4357 ?x7389)))
(let ((?x6880 (+ ?x6164 ?x4546)))
(let ((?x8248 (+ ?x6880 ?x420)))
(let ((?x2774 (+ ?x8248 ?x435)))
(let ((?x11026 (+ ?x2774 ?x159)))
(let ((?x7176 (+ ?x11026 ?x5357)))
...
(let ((?x1448 (- ?x7779 ?x7176)))
(let ((?x6460 (- 0.0 ?x1448)))
(let (($x4554 (>= ?x1448 0.0)))
(let ((?x5488 (ite $x4554 ?x1448 ?x6460)))
...
(let ((?x7139 (* ?x4937 |ElbowLeft Norm|)))
(let ((?x123 (* (/ 129.0 500.0) 0.0)))
(let ((?x7805 (* (~ (/ 193.0 200.0)) 1.0)))
(let ((?x8175 (+ ?x7805 ?x123)))
(let ((?x363 (* (/ 193.0 200.0) 1.0)))
(let ((?x364 (+ ?x363 ?x123)))
(let ((?x10967 (ite $x350 ?x364 ?x8175)))
(let ((?x9184 (+ ?x10579 ?x123)))
(let ((?x368 (+ ?x116 ?x123)))
(let ((?x9432 (ite $x112 ?x368 ?x9184)))
(let ((?x7755 (ite $x5024 ?x9432 ?x10967)))
(let ((?x6183 (* ?x7755 |WristLeft Norm|)))
(let ((?x3426 (+ 0.0 ?x5556)))
(let ((?x7557 (+ ?x3426 ?x6183)))
(let ((?x7323 (+ ?x7557 ?x7139)))
(let ((?x8165 (+ ?x7323 ?x417)))
(let ((?x6343 (+ ?x8165 ?x427)))
(let ((?x8874 (+ ?x6343 ?x443)))
(let ((?x10631 (+ ?x8874 ?x5556)))
...
(let ((?x10415 (- ?x7959 ?x10631)))
(let ((?x7326 (- 0.0 ?x10415)))
(let (($x1691 (>= ?x10415 0.0)))
(let ((?x1840 (ite $x1691 ?x10415 ?x7326)))
...
(let ((?x3051 (* ?x4935 |ElbowLeft Norm|)))
(let ((?x360 (+ ?x123 ?x116)))
(let ((?x10826 (+ ?x123 ?x10579)))
(let ((?x7078 (ite $x112 ?x10826 ?x360)))
(let ((?x1016 (ite $x5024 ?x7078 0.0)))
(let ((?x7784 (* ?x1016 |WristLeft Norm|)))
(let ((?x4526 (+ 0.0 ?x5403)))
(let ((?x7552 (+ ?x4526 ?x7784)))
(let ((?x6436 (+ ?x7552 ?x3051)))
(let ((?x8158 (+ ?x6436 ?x416)))
(let ((?x7824 (+ ?x8158 ?x426)))
(let ((?x1308 (+ ?x7824 ?x441)))
(let ((?x2853 (+ ?x1308 ?x5403)))
...
(let ((?x10625 (- ?x7955 ?x2853)))
(let ((?x10117 (- 0.0 ?x10625)))
(let (($x3490 (>= ?x10625 0.0)))
(let ((?x6085 (ite $x3490 ?x10625 ?x10117)))
(let (($x5493 (>= ?x6085 ?x1840)))
(let ((?x3814 (ite $x5493 ?x6085 ?x1840)))
(let (($x379 (>= ?x3814 ?x5488)))
(let ((?x152 (ite $x379 ?x3814 ?x5488)))
(let (($x6494 (< ?x152 (/ 1.0 5.0))))
(let (($x7697 (and true $x6494)))
...
(let (($x8309 (and $x10995 true)))
(let (($x7659 (and $x8309 $x7697)))
(let (($x6578 (and $x7659 true)))
