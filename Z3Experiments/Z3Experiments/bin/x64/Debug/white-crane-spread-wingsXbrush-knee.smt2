; white-crane-spread-wingsXbrush-knee
...
(let ((?x7522 (* (/ 7.0 80.0) ?x391)))
(let ((?x6289 (* (/ 249.0 250.0) ?x395)))
(let (($x10118 (>= ?x395 0.0)))
(let ((?x6007 (- 0.0 ?x395)))
(let ((?x10873 (ite $x10118 ?x395 ?x6007)))
(let ((?x5213 (+ ?x169 ?x176)))
(let ((?x4162 (+ ?x169 ?x179)))
...
(let ((?x7133 (- 0.0 ?x346)))
(let (($x8110 (>= ?x346 0.0)))
(let ((?x7408 (ite $x8110 ?x346 ?x7133)))
(let (($x9176 (>= ?x7408 ?x10873)))
(let ((?x8490 (ite $x9176 ?x395 (ite $x10118 (+ ?x6289 (* (~ (/ 7.0 80.0)) ?x391)) (+ ?x6289 ?x7522)))))
(let ((?x4357 (+ 0.0 ?x5357)))
(let ((?x7765 (+ (+ (+ ?x4357 (* ?x8490 |WristLeft Norm|)) (* ?x395 |ElbowLeft Norm|)) ?x420)))
(let ((?x258 (* |HipLeft Z| |HipLeft Norm|)))
(let ((?x6537 (+ 0.0 ?x258)))
(let ((?x6544 (+ ?x6537 ?x258)))
(let ((?x9990 (- ?x6544 (+ (+ (+ ?x7765 ?x435) ?x159) ?x5357))))
(let ((?x11507 (ite (>= ?x9990 0.0) ?x9990 (- 0.0 ?x9990))))
...
(let ((?x8158 (ite $x10118 (+ (* (/ 7.0 80.0) ?x395) (* (/ 249.0 250.0) ?x391)) (+ (* (~ (/ 7.0 80.0)) ?x395) (* (/ 249.0 250.0) ?x391)))))
(let ((?x1080 (ite $x8110 (+ (* (/ 7.0 80.0) ?x346) (* (/ 249.0 250.0) ?x391)) (+ (* (~ (/ 7.0 80.0)) ?x346) (* (/ 249.0 250.0) ?x391)))))
(let ((?x9909 (ite $x9176 ?x1080 ?x8158)))
(let ((?x3426 (+ 0.0 ?x5556)))
(let ((?x967 (+ (+ (+ ?x3426 (* ?x9909 |WristLeft Norm|)) (* ?x391 |ElbowLeft Norm|)) ?x417)))
(let ((?x257 (* |HipLeft Y| |HipLeft Norm|)))
(let ((?x6430 (+ 0.0 ?x257)))
(let ((?x6588 (+ ?x6430 ?x257)))
(let ((?x377 (- ?x6588 (+ (+ (+ ?x967 ?x427) ?x443) ?x5556))))
(let ((?x6201 (ite (>= ?x377 0.0) ?x377 (- 0.0 ?x377))))
...
(let ((?x10967 (ite $x8110 (+ (* (/ 249.0 250.0) ?x346) (* (~ (/ 7.0 80.0)) ?x391)) (+ (* (/ 249.0 250.0) ?x346) ?x7522))))
(let ((?x7755 (ite $x9176 ?x10967 ?x346)))
(let ((?x4526 (+ 0.0 ?x5403)))
(let ((?x3814 (+ (+ (+ ?x4526 (* ?x7755 |WristLeft Norm|)) (* ?x346 |ElbowLeft Norm|)) ?x416)))
(let ((?x256 (* |HipLeft X| |HipLeft Norm|)))
(let ((?x6894 (+ 0.0 ?x256)))
(let ((?x6584 (+ ?x6894 ?x256)))
(let ((?x382 (- ?x6584 (+ (+ (+ ?x3814 ?x426) ?x441) ?x5403))))
(let ((?x1246 (ite (>= ?x382 0.0) ?x382 (- 0.0 ?x382))))
(let ((?x6325 (ite (>= ?x1246 ?x6201) ?x1246 ?x6201)))
...
(let ((?x357 (+ ?x356 ?x116)))
(let ((?x1205 (* (ite $x5024 1.0 (ite $x350 (+ ?x356 (* (~ (/ 193.0 200.0)) 0.0)) ?x357)) |WristLeft Norm|)))
(let ((?x7738 (+ (+ (+ (+ (+ ?x4357 ?x1205) (* ?x4943 |ElbowLeft Norm|)) ?x420) ?x435) ?x159)))
...
(let ((?x6397 (- ?x7779 (+ ?x7738 ?x5357))))
(let ((?x8773 (ite (>= ?x6397 0.0) ?x6397 (- 0.0 ?x6397))))
...
(let ((?x364 (+ ?x363 ?x123)))
(let ((?x1937 (ite $x5024 (ite $x112 (+ ?x116 ?x123) (+ (* (~ (/ 193.0 200.0)) 0.0) ?x123)) (ite $x350 ?x364 (+ (* (~ (/ 193.0 200.0)) 1.0) ?x123)))))
(let ((?x11279 (+ (+ (+ ?x3426 (* ?x1937 |WristLeft Norm|)) (* ?x4937 |ElbowLeft Norm|)) ?x417)))
...
(let ((?x10959 (- ?x7959 (+ (+ (+ ?x11279 ?x427) ?x443) ?x5556))))
(let ((?x11509 (ite (>= ?x10959 0.0) ?x10959 (- 0.0 ?x10959))))
(let ((?x8098 (* (ite $x5024 (ite $x112 (+ ?x123 (* (~ (/ 193.0 200.0)) 0.0)) (+ ?x123 ?x116)) 0.0) |WristLeft Norm|)))
(let ((?x8072 (+ (+ ?x4526 ?x8098) (* (ite $x5024 (ite $x112 ?x5213 ?x4162) 0.0) |ElbowLeft Norm|))))
...
(let ((?x7360 (- ?x7955 (+ (+ (+ (+ ?x8072 ?x416) ?x426) ?x441) ?x5403))))
(let ((?x10955 (ite (>= ?x7360 0.0) ?x7360 (- 0.0 ?x7360))))
(let ((?x6886 (ite (>= ?x10955 ?x11509) ?x10955 ?x11509)))
...
(let (($x10995 (and $x7616 (and true (< ?x10034 ?x5646)))))
(let (($x8856 (and (and $x10995 true) (and true (< (ite (>= ?x6886 ?x8773) ?x6886 ?x8773) (/ 1.0 5.0))))))
(let (($x153 (and (and $x8856 true) (and true (< (ite (>= ?x6325 ?x11507) ?x6325 ?x11507) (/ 1.0 5.0))))))
...
(let (($x1404 (and $x5034)))
(and $x1404 (and (and (and true $x6992) $x7041) $x7944) $x153)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
